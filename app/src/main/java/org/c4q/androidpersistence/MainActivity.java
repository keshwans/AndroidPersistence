...
//        saveDataToBundle(outState);
    ...
    private void saveDataToBundle(Bundle outState) {
        outState.putInt(PREF_KEY_USER_COUNT, mUserCount);
    }
    //adb pull /data/data/org.c4q.androidpersistence/shared_prefs/org.c4q.androidPersistence_3.xml
    ...
    private void saveDataToSharedPref() {
        ...
        //editor.remove(PREF_KEY_USER_COUNT); to delete the key
    }
